 ...
 *
 * Variants: no allowed sanitized Falabella detail fixture proving variant
 * id/sku/color/size/stock/image fields has been captured yet. Per policy,
 * every Falabella product therefore emits `variantsObserved:false,
 * variants:[]` rather than guessing a shape or escalating to browser
 * automation. Implement real mapping only after capturing and checking in
 * such a fixture (see @scrapito/contracts VariantInputSchema).
 */
